...
fecha: 2026-05-18
revision: 2026-05-20 (r6) — Spec 42 bumpeada a borrador-r2: cerradas las 3 decisiones visuales del Anexo A en sesión de Product Design (A.4 combinación tooltip + drawer; B.4 dirección solo en leyenda y tooltip; C.4 glyph nube + gotas). Spec lista para handoff a VS Code sin decisiones bloqueantes
tipo: documento-epic
...
| 42 | Capa precipitación: crecimiento económico | Spec 39, 40 | **borrador-r2** — 15 decisiones cerradas (12 técnicas en r1 + 3 visuales en r2 por Anexo A). Lista para handoff a VS Code sin decisiones bloqueantes |
